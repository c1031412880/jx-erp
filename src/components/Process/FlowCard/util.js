...
export class NodeUtils {
  ...
  static createNode ( type, previousNodeId ) {
    ...
    res.nodeId = this.idGenerator() + Math.round(Math.random() * 10000)
  ...
  static deleteNode ( nodeData, processData, checkEmpty = true ) {
    console.log(nodeData, processData, 'deleteNode')
  ...
  static appendBranch ( data, isBottomBtnOfBranch ) {
    console.log(data, isBottomBtnOfBranch)
 ...
 */
  ...
  static checkNode ( node, parent ) {
    ...
    const customSettings = ['myself', 'optional', 'director', 'chargeDirector','relevance']
