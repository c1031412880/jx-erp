 ...
 <el-row :gutter="12">
   ...
   <el-col :span="isRange?24:12">
     ...
     <div style="width:100%;overflow:hidden;margin-top:10px;" v-else>
       ...
       <el-col :span="4">
         <el-select v-model="cloneData.value[1]" class="range-date" size="small" placeholder="请选择" @change="update">
       ...
       <el-col :span="4">
         <el-select v-model="cloneData.value[2]" class="range-date" size="small" placeholder="请选择" @change="update">
           <el-option label="<" value="lt"></el-option>
           <el-option label="≤" value="lte"></el-option>
         </el-select>
       </el-col>
...
export default {
  ...
  methods: {
    onTypeChange(newVal) {
      if (newVal === "bet") {
        this.cloneData.value = [1, "lte", "lte", 2];
      }
      this.update();
    },
    update() {
