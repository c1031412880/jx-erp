      ...
      >
        <el-form-item label="类型:" prop="type">
          <el-radio-group  v-model="ruleForm.type">
            ...
            <el-radio :label="2" disabled><span style="color:#606266">电表</span></el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item :label="ruleForm.type === 2? '电表名称':'地址名称'" prop="name">
...
export default {
  ...
  methods: {
    ...
    configTitle() {
      if (this.curType == "add") {
        this.showTitle = "添加地址或电表";
      } else{
        this.showTitle = "编辑地址或电表";
      }
    },
