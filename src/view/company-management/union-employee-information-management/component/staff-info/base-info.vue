  ...
  <div class="base-info" style="height:400px;overflow-x:hidden">
    ...
    >
        ...
        <div class="el-form-row-first-right" prop="c_photo">
          ...
          <div class="avatar-box-content show-flex-box-c" v-if="formData.c_photo">
            ...
            <i class="delete-icon el-icon-delete" :class="{'no-show-delete-icon':curChangeType == 'detail'}" v-if="formData.c_photo" @click.stop="deleteImage()"></i>
             <el-button icon="el-icon-plus" size="mini" @click="uploadFile" v-if="formData.c_photo" :disabled="true">更换图片</el-button>
          </div>
           
            <!-- <img v-if="formData.c_photo" :src="formData.c_photo" class="avatar" /> -->
            <i v-if="!formData.c_photo" class="avatar-uploader-icon"
              ><el-button class="el-icon-upload2"  @click="uploadFile" :disabled="true">上传图片</el-button></i>
      ...
      <div class="el-form-row">
        <el-form-item label="职位:" prop="position_job">
            <!-- <get-position-list ref="positionList" v-model="formData.position_id" @change="changePosition" :dept_id="dept_id" :multiple="true" :disabled="true" v-if="showCollapse == 'first'"></get-position-list> -->
            <!-- <el-select 
            ...
            <el-input
              placeholder="请输入职位"
              v-model="formData.position_job"
            ></el-input>
          </el-form-item>
          <el-form-item label="职务:" prop="i_job_level">
            <el-select v-model="formData.i_job_level" placeholder="请选择职务" :disabled="true">
              <el-option
      ...
      <div class="el-form-row">
        <el-form-item label="职级:" prop="rank">
            <el-select v-model="formData.rank" placeholder="请选择职级" :disabled="true">
              <el-option
          ...
          <el-form-item label="性别:" prop="c_gender">
            <el-select v-model="formData.c_gender" placeholder="请选择性别" :disabled="true">
              <el-option
      ...
      <div class="el-form-row" v-if="showCollapse == 'second'">
        <el-form-item label="线路:" prop="i_line_id">
          <el-select v-model="formData.i_line_id" placeholder="请选择线路" :disabled="true">
            <el-option
        ...
        <el-form-item label="车辆:" prop="i_vehicle_id">
          <el-select v-model="formData.i_vehicle_id" placeholder="请选择车辆" :disabled="true">
            <el-option
      ...
      <div class="el-form-row">
        <!-- <el-form-item label="工种属性:" prop="c_work_kind">
          <el-select v-model="formData.c_work_kind" placeholder="请选择工种属性" :disabled="true">
            <el-option
        ...
        <el-form-item label="状态:" prop="i_job_state">
           <!-- <el-select v-model="formData.i_job_state" placeholder="请选择状态" :disabled="true">
            <el-option
      ...
      <div class="el-form-row">
        <el-form-item label="用工形式:" prop="c_employee_type">
          <!-- <el-select v-model="formData.c_employee_type" placeholder="请选择用工形式" :disabled="true">
            <el-option
...
export default {
  ...
  methods: {
    ...
    selectedUser(id) {
      ...
      let params = {}
      params.id = id
      this.$client.getEmployeeManageDetail(params)
        .then(res => {
          if (res.head.result == "200") {
            // console.log(res.context);
            this.$emit('set-user', res.context, id)
          } else {
            this.$message({
              showClose: true,
