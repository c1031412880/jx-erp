    ...
    <div class="el-dialog-div">
      <el-form
        ...
        <el-form-item label="接收人员" prop="user_id">
          <vue-user-role-tree placeholder="选择接收人员" :show_all="true" :func_type="0" :is_contain_emp="true" :isShowCheckbox="true" v-model="ruleForm.user_id"></vue-user-role-tree>
        </el-form-item>
        <el-form-item label="提醒方式" prop="warn_types">
          <el-checkbox-group v-model="ruleForm.warn_types">
            <el-checkbox :label="'1'" >系统推送</el-checkbox>
            <el-checkbox :label="'2'">app推送</el-checkbox>
            <el-checkbox :label="'3'">短信通知</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="报废提醒时间" prop="warn_day">
          <p>提前提醒，当天再次提醒，提前
            <el-input-number style="width: 80px" v-model="ruleForm.warn_day" :min="1" label="描述文字" :precision="0" :controls="false"></el-input-number>
            天提醒。
          </p>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    setData(info) {
      ...
      this.ruleForm.warn_types = info.warn_types.split(',')
      console.log(info, this.ruleForm);
    },
    onSaveAlarmSet() {
      this.$refs['ruleForm'].validate((valid) => {
        ...
        if (valid) {
          ...
          info.warn_types = this.ruleForm.warn_types.join()
