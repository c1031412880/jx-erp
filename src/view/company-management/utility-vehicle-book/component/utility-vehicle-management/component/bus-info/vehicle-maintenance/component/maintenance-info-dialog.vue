<template>
  ...
  >
    <div class="el-dialog-div">
      <el-form ref="form" size="mini" :model="form" :rules="rules" label-width="160px" label-suffix=":">
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="关联审批单" prop="rule_name">
              <!-- <el-input v-model="form.rule_name" style="width:100%" disabled placeholder="请选择关联保养单"></el-input> -->
              <el-input v-model="form.title" @click.native="choiceOver()" placeholder="请选择关联保养单" class="over" style="width:100%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保养日期" prop="maintain_date">
              <el-date-picker
                :disabled="disabled"
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="车牌号" prop="code">
              <el-input v-model="form.code" style="width:100%" disabled placeholder="请输入车牌号"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保养时公里数(公里)" prop="maintain_mile">
              <el-input-number v-model="form.maintain_mile" style="width:100%" :disabled="disabled"  :min="0" :precision="2" :controls="false"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保养类型" prop="type">
              <get-select-dictionaries  style="width:100%" :disabled="disabled" v-model="form.type" :classKey="'保养类型'" placeholder="请选择保险种类"></get-select-dictionaries>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保养金额(元)" prop="maintain_fee">
              <el-input-number v-model="form.maintain_fee" style="width:100%" :disabled="disabled"  :min="0" :precision="2" :controls="false"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="保养负责人" prop="maintain_user">
              <get-department-select
                ref="personalTree"
                v-model="form.maintain_user"
          ...
          <el-col :span="12">
            <el-form-item label="上次保养日期" prop="up_date">
              <el-date-picker
                disabled
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="上次保养里程" prop="up_mile">
              <el-input-number v-model="form.up_mile" style="width:100%" disabled  :min="0" :precision="2" :controls="false"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="24">
    ...
    <el-dialog
      ...
      <el-table
        ...
        <el-table-column label="申请部门" prop="department"></el-table-column>
        <el-table-column label="保养日期" prop="maintain_date"></el-table-column>
        <el-table-column label="车牌号" prop="code"></el-table-column>
        <el-table-column label="保养类型" prop="maintain_type_name"></el-table-column>
        <el-table-column label="预估材料费总金额（元）" prop="material_fee" width="180"></el-table-column>
        <el-table-column label="预估工时费总金额（元）" prop="hours_fee" width="180"></el-table-column>
        <el-table-column label="预估总金额（元）" prop="total_fee" width="160"></el-table-column>
        <el-table-column label="上次保养日期" prop="up_date" width="120"></el-table-column>
        <el-table-column label="上次保养里程（公里）" prop="up_mile" width="160"></el-table-column>
...
export default {
  ...
  mounted() {
    this.form.maintain_date = formatDate(new Date(),"yyyy-MM-dd")
    if (getUser()) {
      this.form.maintain_user = Number(JSON.parse(getUser()).user_id)
    }
    let bus_info =  JSON.parse(this.bus_info)
    this.form.code = bus_info.code
    this.form.maintain_mile = bus_info.last_mile
    this.form.up_date = bus_info.last_maintain
    this.form.up_mile = bus_info.last_maintain_mile
    this.GetOaBusMaintain()
  },
  methods: {
    // 选择审批单
    choiceOver() {
    ...
    checked_name() {
      ...
      this.form.title = this.overInfo.user_name + "提交的公车保养单"
      this.form.maintain_fee = this.overInfo.total_fee
      this.form.type = this.overInfo.maintain_type
      this.overVisible = false
    },
    // 多选只能选一个
    ...
    GetOaBusMaintain() {
      ...
      let params = {
        state: 2,
        bus_id: JSON.parse(this.bus_info).id
      }
      this.$client.GetOaBusMaintain(params).then(res => {
    ...
    openApply(row, type) {
      ...
      // let detail_id = 1260, title = '公车保养申请'
      // this.$router.push({
