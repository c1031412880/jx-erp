    ...
    <div class="el-dialog-div">
      <el-form ref="form" size="mini" :model="form" :rules="rules" label-width="120px" label-suffix=":">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="登记证书日期" prop="buy_date">
              <el-date-picker
                disabled
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="车龄" prop="bus_age">
              <el-input v-model="form.bus_age" style="width:100%" disabled clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="年检周期" prop="interval_name">
              <el-select v-model="form.interval_name" :disabled="disabled" style="width:100%" placeholder="请选择">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="本次年检日期" prop="check_date">
              <el-date-picker
                :disabled="disabled"
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="年审金额" prop="check_fee">
              <el-input-number v-model="form.check_fee" style="width:100%" :disabled="disabled"  :min="0" :precision="2" :controls="false"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="年审负责人" prop="check_user">
...
export default {
  ...
  mounted() {
    this.form.check_date = formatDate(new Date(),"yyyy-MM-dd")
    if (getUser()) {
      this.form.check_user = Number(JSON.parse(getUser()).user_id)
    }
    let bus_info = JSON.parse(this.bus_info)
    this.form.code = bus_info.code
    this.form.bus_age = bus_info.bus_old
    this.form.buy_date = bus_info.buy_date
  },
  methods: {
    // 重置
    resetFrom() {
