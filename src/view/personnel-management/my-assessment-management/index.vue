<template>
  <div class="my-assessment-management">
    <sub-req
      ref="head"
      @on-add="openAddPage"
      @on-ok="onSubmit"
    ...
    >
      <template slot-scope="scope" slot="operation">
          <el-button type="primary" size="mini" @click="editRowInfo(scope.data)" v-if="$isPowerShow('edit')">查看</el-button>
          <el-popconfirm
...
export default {
  ...
  methods: {
    ...
    openAddPage(type) {
      ...
      this.informationDialogTitle = "考核人员详情";
      this.informationDialogShow = true;

      // let errorData = [];
      // let list = [1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2]
