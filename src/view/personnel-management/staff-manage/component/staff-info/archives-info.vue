      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="合同类型:" prop="d_labor_contract_type ">
            <el-select v-model="formData.d_labor_contract_type" clearable placeholder="请选择合同类型" :disabled="curChangeType == 'detail'">
            <el-option
        ...
        <el-col :span="8">
          <el-form-item label="参军开始时间:" prop="d_join_army_begin">
            <el-date-picker
              ...
              :disabled="curChangeType == 'detail' || !formData.i_is_join_army">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="军龄（月）:" prop="join_army_age">
            <el-input-number v-model="formData.join_army_age" placeholder="请填写军龄" clearable
              :style="{width: '100%'}" :controls="false" :disabled="curChangeType == 'detail' || !formData.i_is_join_army"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="党员备注:" prop="c_party_remark">
            <el-input v-model="formData.c_party_remark" type="textarea" placeholder="请输入党员备注"
              :autosize="{minRows: 1, maxRows: 1}" :disabled="curChangeType == 'detail'"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
