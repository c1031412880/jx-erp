    ...
    <div class="staff-manage">
      ...
      <div class="" v-show="showCollapse == 'first'">
        <sub-req-first ref="head"
          ...
          @on-AdvancedSet="openAdvancedSetPop"
        ></sub-req-first>
 ...
 import drawerDialog from "./component/dialog/drawer-dialog";
  ...
  export default {
    ...
    components: {
      ...
      staffOverviewInfo,AddStaffDialog,circuitAllocationDialogleaveStaffDialog,drawerDialog
    },
    data() {
      return {
    ...
    methods: {
      ...
      setHead(type) {
        ...
        setTimeout(() => {
          ...
          this.TableHeight = maxh - th - paginationH - staffOverviewInfo -50;
