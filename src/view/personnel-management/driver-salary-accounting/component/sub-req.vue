  ...
  <div>
    <el-form :inline="true" size="mini">
      <el-row>
        ...
        <el-form-item>
          <el-button type="primary" @click="onBtn('add')" 
            >添加奖金</el-button
          >
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onBtn('addRules')" v-if="$isPowerShow('addRules')"
            >薪资规则设定</el-button
          >
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onBtn('issue')"
            >下发工资条</el-button
          >
        </el-form-item>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if(!!info.driver_id && info.driver_id.length == 0) {
