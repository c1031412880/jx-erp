...
export default {
  ...
  data() {
    return {
      ...
      rowspanObj: {},
      mergekeys: ['article_id','article_name','article_platform','score','hire_time','advert_title']
    }
  },
  mounted() {
    this.$nextTick(() => {
      ...
      this.$client.GetUserAdvertScoreDetail({context:params})
        .then(res => {
          ...
          if (res.head.result == "200") {
            ...
            // this.rowspanObj = this.$handleTableSpan(this.mergekeys, this.data,'article_id',true)
          } else {
            this.loading = false;
            this.$message({
              showClose: true,
