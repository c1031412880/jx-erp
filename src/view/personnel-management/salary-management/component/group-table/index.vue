...
export default {
    ...
    return {
      ...
      customSettingList: [
        ...
        },
        {
          id: 5,
          label: "月基本年薪(元)",
          prop: "monthly_basic_annual_salary",
          width: "130",
          align: "center",
          signIndex: 4,
        },
      ...
      FileData: {
        url: window.newHttpConfig.URL_EASYMOCK +  "/Files/TempFiles/集团员工薪资管理导入模板.xlsx",
      },
    };
  },
  mounted() {
  ...
  methods: {
    ...
    importStaffInfoExcel(val){
      ...
      let params = formData;
      this.$client.ReadPersonFile(params)
      .then(res => {
        if(res.head.result == "200") {
