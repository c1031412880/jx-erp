    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="待确认" name="first" lazy>
        <cor-box :height="carHeight">
          <unconfirmed-separation :resignated='false'></unconfirmed-separation>
        </cor-box>
      </el-tab-pane>
      ...
      <el-tab-pane :label="label" name="third" lazy>
        <cor-box :height="carHeight">
          ...
          <unconfirmed-separation :resignated='true' @out-num="setRetiredPersonnelNum"></unconfirmed-separation>
        </cor-box>
      </el-tab-pane>
    </el-tabs>
  </div>
