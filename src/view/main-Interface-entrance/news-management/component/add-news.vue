<template>
  <el-dialog
      ...
      <el-row>
        <el-col :span="12" style="padding-right: 20px;">
          ...
          <el-form-item label="" prop="top">
            <el-checkbox v-model="form.top" :true-label="1" :false-label="0">设为置顶新闻</el-checkbox>
          </el-form-item>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button @click="saveNewsInfo(1)" type="primary" size="mini">发 布</el-button>
    </span>
...
export default {
  components: {tinymceVue,newDialog,getDepartmentSelect,getSelectDictionaries,},
  props: {
    dialogBool: Boolean,
    title: {
      type: String,
