  ...
  <div class="monthly-work-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>开始时间</p>
          <em>{{formData.start_date}} {{dataOptions[formData.start_time]}}</em>
        </el-col>
        <el-col :span="12">
          <p>结束时间</p>
          <em>{{formData.end_date}} {{dataOptions[formData.end_time]}}</em>
        </el-col>
        <el-col :span="12">
          <p>请假时长(天)</p>
          <em>{{formData.day}}</em>
