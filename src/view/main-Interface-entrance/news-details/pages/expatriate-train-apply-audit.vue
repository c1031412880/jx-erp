  ...
  <div class="bus-decoration-maintenance-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>性别</p>
          <em>{{ formData.gender }}</em>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <p>出生日期</p>
          <em>{{ formData.birthday }}</em>
        </el-col>
        <el-col :span="12">
          <p>工龄</p>
          <em>{{ formData.work_ages }}</em>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <p>岗位或工种</p>
          <em>{{ formData.work_position }}</em>
        </el-col>
        <el-col :span="12">
          <p>文化程度</p>
          <em>{{ formData.education }}</em>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
        ...
        <el-col :span="12">
          <p>培训单位</p>
          <em>{{ formData.training_unit }}</em>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <p>申请培训课目</p>
          <em>{{ formData.training_subject }}</em>
        </el-col>
        <el-col :span="12">
          <p>培训方式</p>
          <em>{{ formData.training_type }}</em>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <p>培训日期</p>
          <em>{{ formData.training_date }} 至 {{ formData.training_end_date }}</em>
        </el-col>
        <el-col :span="12">
          <p>应付学费(人民币大写)</p>
          <em>{{ formData.tuition_fee }}</em>
        </el-col>
      </el-row>
