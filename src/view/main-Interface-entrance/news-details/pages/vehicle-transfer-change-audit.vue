...
<template>
  <div class="vehicle-transfer-change-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>调出部门</p>
          <em>{{formData.out_depts}}</em>
        </el-col>
        <el-col :span="12">
          <p>调出线路</p>
          <em>{{formData.out_lines}}</em>
        </el-col>
        <el-col :span="12">
          <p>调入部门</p>
          <em>{{formData.target_dept_name}}</em>
        </el-col>
        <el-col :span="12">
          <p>调入线路</p>
          <em>{{formData.target_line_name}}</em>
        </el-col>
        <el-col :span="24">
          <p>变更原因</p>
          <el-input v-model="formData.deploy_reason" autosize type="textarea" class="richText" disabled ></el-input>
        </el-col>
        <el-col :span="24">
          <p>车辆附件设备</p>
          <el-input v-model="formData.attachment" autosize type="textarea" class="richText" disabled ></el-input>
        </el-col>
      </el-row>
...
export default {
  name: "vehicle-transfer-change-audit",
  components: {
    itemBoxNew,
    titleBoxNew,
    imageFileUpload,
