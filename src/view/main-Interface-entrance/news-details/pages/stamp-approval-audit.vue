  ...
  <div class="work-contact-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>日期</p>
          <em>{{formData.apply_date}}</em>
        </el-col>
        <el-col :span="12">
          <p>图章名称</p>
          <em>{{formData.seal_name}}</em>
        </el-col>
        <el-col :span="12">
          <p>是否对外签订合同、协议</p>
          <em>{{formData.is_foreign == 1 ? '是' : '否'}}</em>
        </el-col>
        <el-col :span="12">
          <p>份数</p>
        ...
        <el-col :span="24">
          <p>盖章内容</p>
          <el-input autosize type="textarea" class="richText" disabled v-model="formData.content"></el-input>
        </el-col>
      </el-row>
