<template>
  <div class="small-purchase-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>经办时间</p>
          <em>{{formData.duty_date}}</em>
        </el-col>
        <el-col :span="12">
          <p>采购类型</p>
          <em>{{formData.purchase_type_name}}</em>
        </el-col>
        <el-col :span="12">
          <p>估算金额(元)</p>
          <em>{{formData.estimated_amount}}</em>
        </el-col>
        <el-col :span="24">
          <p>申请事由</p>
          <el-input autosize type="textarea" class="richText" disabled v-model="formData.apply_reason"></el-input>
        </el-col>
        <el-col :span="24">
          <p>备注</p>
