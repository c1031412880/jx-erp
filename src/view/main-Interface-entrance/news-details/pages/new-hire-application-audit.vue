  ...
  <div class="work-contact-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>本年度已录用员工（人）</p>
          <em>{{formData.employed_count}}</em>
        </el-col>
        <el-col :span="12">
          <p>退休（人）</p>
          <em>{{formData.retire_count}}</em>
        </el-col>
        <el-col :span="12">
          <p>离职（人）</p>
          <em>{{formData.leave_count}}</em>
        </el-col>
        <el-col :span="12">
          <p>申请新招聘人员（人）</p>
          <em>{{formData.apply_count}}</em>
        </el-col>
        <el-col :span="24">
          <p>招聘岗位</p>
          <el-input autosize type="textarea" class="richText" disabled v-model="formData.position"></el-input>
        </el-col>
        <el-col :span="24">
          <p>用人原因</p>
...
export default {
  name: "new-hire-application-audit",
  components: {
    itemBoxNew,
    titleBoxNew,
    imageFileUpload,
