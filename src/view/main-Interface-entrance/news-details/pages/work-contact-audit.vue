  ...
  <div class="work-contact-audit" v-loading="loading">
    ...
    <item-box-new title="基本信息">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <p>主送部门经办人</p>
          <em>{{formData.handling_user_name}}</em>
        </el-col>
        <el-col :span="12">
          <p>主送部门</p>
          <em>{{formData.handling_dept_name}}</em>
        </el-col>
        <el-col :span="12">
          <p>日期</p>
        ...
        <el-col :span="24">
          <p>主题</p>
          <em>{{formData.theme}}</em>
        </el-col>
        <el-col :span="24">
          <p>联系内容</p>
          <el-input autosize type="textarea" class="richText" disabled v-model="formData.connect_content"></el-input>
        </el-col>
      </el-row>
