  ...
  <div class="asset-classification">
    ...
    <el-card class="right-box">
      ...
      <div class="show-box">
        <span>已选物品：</span>
        <div class="title-tag">
          <el-tag style="margin: 0 5px" size="mini" effect="dark" type="success" v-for="item in selectedList" :key="item.id">{{item.goods_name}}</el-tag>
        </div>
      </div>
      <tr-table
        ref="trTable"
  ...
  methods: {
    ...
    setHead() {
      setTimeout(() => {
        ...
        console.log("this.TableHeight",this.TableHeight,maxh,th,paginationH)
      }, 60);
    },
  }
}
