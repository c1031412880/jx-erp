      ...
      <el-row :gutter="10">
        <el-col :span="24">
          <el-form-item label="类型:" prop="type">
            <el-radio-group v-model="form.type" :disabled="curSelectedType === 'detail'">
              <el-radio :label="0">培训</el-radio>
              <el-radio :label="1">演练</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item :label="!form.type ? '培训名称' : '演练名称'" prop="name">
            <el-input
              v-model="form.name"
              clearable
              :disabled="curSelectedType === 'detail'"
              :placeholder="!form.type ? '请输入培训名称' : '请输入演练名称'"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="!form.type ? '培训日期' : '演练日期'" prop="date">
            <el-date-picker
              v-model="date"
              type="daterange"
              format="yyyy-MM-dd"
        ...
        <el-col :span="12">
          <el-form-item :label="!form.type ? '培训地点' : '演练地点'" prop="place_name">
            <!-- <tr-select-dictionaries
              v-model="form.place_id"
              :classKey="'培训(演练)地点'"
              style="width: 100%"
              :placeholder="!form.type ? '请选择培训地点' : '请选择演练地点'"
              :disabled="curSelectedType === 'detail'"
            ></tr-select-dictionaries> -->
            <el-input
              ...
              clearable
              :disabled="curSelectedType === 'detail'"
              :placeholder="!form.type ? '请输入培训地点' : '请输入演练地点'"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="24">
          <el-form-item :label="!form.type ? '培训内容' : '演练内容'" prop="message">
            <el-input
              ...
              style="width: 100%"
              :disabled="curSelectedType === 'detail'"
              :placeholder="!form.type ? '请输入培训内容' : '请输入演练内容'"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
...
export default {
  ...
  data() {
    return {
      ...
      basicRules: {
        name: [{ required: true, message: '请输入培训/演练名称', trigger: 'change' }],
        date: [{ required: true, message: '请输入培训/演练日期', trigger: 'change' }],
        end_date: [{ required: true, message: '请输入结束日期', trigger: 'change' }],
        start_time: [{ required: true, message: '请选择开始时间', trigger: 'change' }],
        end_time: [{ required: true, message: '请选择结束时间', trigger: 'change' }],
        place_name: [{ required: true, message: '请输入培训/演练地点', trigger: 'change' }],
        compere: [{ required: true, message: '请选择主持人', trigger: 'change' }],
        recorder: [{ required: true, message: '请选择记录人', trigger: 'change' }],
        message: [{ required: true, message: '请输入培训/演练纪要', trigger: 'change' }]
      }
    }
  },
  watch: {
