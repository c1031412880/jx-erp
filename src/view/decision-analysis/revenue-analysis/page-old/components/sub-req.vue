<template>
  <el-form :inline="true" size="mini">
    ...
    <el-form-item>
      <get-vehicle-select-tree v-model="form.vehicle_ids" :isShowCheckbox="true" placeholder="选择车辆"></get-vehicle-select-tree>
    </el-form-item>
    <el-form-item>
      <get-line-select-tree ref="getLineSelectTree" v-model="form.line_ids" :isShowCheckbox="true"  placeholder="选择线路"></get-line-select-tree>
    </el-form-item>
    <el-form-item>
