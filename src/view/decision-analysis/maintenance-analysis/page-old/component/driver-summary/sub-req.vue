<template>
  <el-form :inline="true" size="mini">
    ...
    <el-form-item>
      <get-vehicle-select-tree placeholder="选择车辆" v-model="form.vehicle_id"></get-vehicle-select-tree>
    </el-form-item>
    <el-form-item>
      <get-line-select-tree  ref="getLineSelectTree" placeholder="选择线路" v-model="form.line_id"></get-line-select-tree>
    </el-form-item>
    <el-form-item>
