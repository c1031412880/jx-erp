  ...
  <div>
    <el-form :inline="true" size="mini">
      <el-row>
        ...
        <!-- 分公司多选 -->
        <el-form-item label="分公司:" prop="dept_ids">
          <get-branch-office
            v-model="form.dept_ids"
            :multiple="true"
            :placeholder="'请选择分公司'"
            style="min-width: 200px;"
            @change="branchOfficeChange"
          ></get-branch-office>
        </el-form-item>
...
export default {
  ...
  methods: {
    // 分公司选择变化处理
    branchOfficeChange(val) {
      console.log('分公司选择变化:', val);
    },
    ...
    onSubmit() {
      try {
        ...
        // 添加分公司参数（可选，如果未选择则传递空数组）
        queryParams.dept_ids = this.form.dept_ids || [];
