<template>
  <div class="sub-req-box">
    <el-form :inline="true" size="mini" :model="form" ref="form">
      ...
      <el-form-item prop="vehicle_ids" v-if="curType">
      ...
      <el-form-item prop="line_ids" v-else> 
      ...
      <el-form-item>
        ...
        <el-dropdown @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="1">{{curType ? '车辆汇总表1' : '线路汇总表1'}}</el-dropdown-item>
            <el-dropdown-item command="2">{{curType ? '车辆汇总表2' : '线路汇总表2'}}</el-dropdown-item>
            <el-dropdown-item command="3" v-if="!curType">线路汇总表3</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    Reset(formName){
      ...
      // 清空线路选中
      this.reqNextTime()
      this.form.house_id = this.houseOptions[0].id;
      this.onSubmit();
    },
