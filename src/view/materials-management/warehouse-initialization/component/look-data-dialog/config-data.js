export default {
  ...
  engineConfig: {
    ...
    TableHeight: 300,
    TableHeader: [
      {label: "发动机编号", prop: "code", width: "120",sortable:true},
      ...
      {label: "随车里程(km)", prop: "mileage", width: "120",sortable:true},
  ...
  batteryConfig: {
    ...
    TableHeader: [
      ...
      {label: "额定容量", prop: "lp_num", width: "120",sortable:true},
      {label: "混合动力类型", prop: "type_name", width: "120"},
      {label: "电瓶种类", prop: "bat_type", width: "120"},
      {label: "电瓶品牌", prop: "brand", width: "120"},
      {label: "安装日期", prop: "install_date", width: "120",sortable:true},
      {label: "拆卸日期", prop: "scrap_date", width: "120",sortable:true},
      {label: "随车里程", prop: "lp_num", width: "120",sortable:true},
      {label: "备注", prop: "remark", width: "120"},
    ]
  },
  // 轮胎信息
  tyreConfig: {
    ...
    TableHeader: [
      ...
      {label: "轮胎类别", prop: "tyre_mode_name", width: "120"},
  ...
  accidentRecord: {
    ...
    TableHeader: [
      ...
      {label: "事故发生时间", prop: "d_accident_date", width: "120",sortable:true},
