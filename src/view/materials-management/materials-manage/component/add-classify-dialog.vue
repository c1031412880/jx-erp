  ...
  >
    <div class="el-dialog-div">
      <el-form
        ...
        size="mini"
      >
        <el-form-item label="所属分类:" prop="parent_id" v-if="ruleForm.type == 2">
          <el-select v-model="ruleForm.parent_id" placeholder="请选择所属分类">
            <el-option
        ...
        <el-form-item label="是否默认:" prop="is_default">
          <el-switch v-model="ruleForm.is_default" :active-value="1" :inactive-value="0" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    configTitle() {
      if (this.curType == "add") {
        this.showTitle = "添加物料分类";
      } else{
        this.showTitle = "编辑物料分类";
      }
    },
