    ...
    <el-form :inline="true" size="mini">
      <el-row>
        ...
        <el-form-item label="入库方式:">
          <el-select placeholder="全部" clearable v-model="form.enter_type" disabled>
            <el-option
      ...
      <el-row>
        ...
        <el-popconfirm
          ...
          <!-- <el-button @click="deleteSelect()" type="primary" >删除</el-button> -->
        </el-form-item>
        <!-- <el-form-item>
        ...
        <el-form-item>
         ...
         <el-form-item>
          <el-button v-if="$isPowerShow('returnSearch')"  @click="enterReturnSearch()" type="primary">退料单查询</el-button>
        </el-form-item>
        <el-dropdown>
