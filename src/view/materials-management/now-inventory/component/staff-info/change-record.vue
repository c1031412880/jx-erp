...
<!--        </el-col>-->
      ...
      <div class="show-flex-box-r">
        <el-form-item style="margin-left: -80px" prop="">
          ...
          >
            ...
            <el-radio-button :label="'3'">调拨</el-radio-button>
          </el-radio-group>
        </el-form-item>
    ...
    <tr-table
      ...
      :selectionShow="false"
      :data="data3"
      :tableHeaderList="tableHeaderList4"
      :TableHeight="TableHeight"
      :loading="loading"
      :isShowSummary="true"
      :omitColumnIndex='[1,2,3,4,5,6,7,8,10]'
...
<script>
import { formatDateTime, getDate} from "@/utils/index";
export default {
  data() {
    return {
      pageInfo1: {
  ...
  methods: {
    ...
    getChangeDate() {
      this.date =[`${this.date[0]}`, `${this.date[1]} 23:59:59`]
      // this.getdetilCount()
      this.getdetilData();
      this.getdetilData1();
      this.getdetilData2();
    ...
    getdetilData3() {
      this.$client
        .GetByPageInventoryTrans({
          // before_house_id: this.house_id,
      ...
      this.$client
        ...
        .then((res) => {
          ...
          if (res.head.result == "200") {
            ...
            // this.date = this.$addTime([this.formData.date, formatDateTime(new Date())])
            // let timeObj = getDate('thisMonth')
            // this.formData.date = timeObj.startTime + '~' + timeObj.endTime
            this.getdetilData()
            this.getdetilData1()
            this.getdetilData2()
            this.getdetilData3()
