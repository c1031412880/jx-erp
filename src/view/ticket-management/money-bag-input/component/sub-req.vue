  ...
  <div>
    <el-form :inline="true" size="mini">
      ...
      <el-row>
        ...
        <el-form-item>
          <el-button @click="isCheck('sure')" type="primary" v-if="$isPowerShow('check')">
            批量审核
          </el-button>
        </el-form-item>
        <el-form-item>
          <el-button @click="isCheck('cancle')" type="primary" v-if="$isPowerShow('check')">
            取消审核
          </el-button>
        </el-form-item>
        <el-form-item>
          <el-button @click="onBtn('batch')" type="primary" v-if="$isPowerShow('add')">
            批量录入
          </el-button>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      let scapShow = this.onScap - 1
      if(scapShow > -1) info.vechice_state = scapShow
