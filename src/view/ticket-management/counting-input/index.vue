<template>
  <div class="counting-input" ref="countingInput">
    ...
    <div class="counting-input-dialog">
      <information-dialog
...
export default {
  ...
  methods: {
    ...
    // 计算表格高度 和初始化表头
    setHead(type) {
      this.treeBoxHeight = this.$refs.countingInput.offsetHeight - 110;
      if(type == 'initialize') {
...
.counting-input /deep/ .el-card__header {
