      ...
      >
        <el-row :gutter="20">
          <el-col :span="24">
            ...
            <p style="margin-left:15px;margin-bottom:15px;color:#409EFF;font-size:16px;font-weight:bold">安全阀信息</p>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="安全阀类型" prop="valve_type">
              <get-select-dictionaries
                style="width: 100%"
                v-model="form.valve_type"
                :classKey="'安全阀类型'"
                :placeholder="'请选择安全阀类型'"
                clearable
          ...
          <el-col :span="12">
            <el-form-item label="安全阀型号:" prop="valve_model">
              <el-input v-model="form.valve_model" clearable placeholder="请输入" :disabled="curSelecedType == 'detail'"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="要求整定压力(Mpa):" prop="working_pressure">
              <el-input 
          ...
          <el-col :span="12">
            <el-form-item label="安全阀编号:" prop="code">
              <el-input v-model="form.code" clearable placeholder="请输入" :disabled="curSelecedType == 'detail'"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  data() {
    return {
      ...
      basicRules: {
        ...
        valve_type: [
          { required: true, message: "请选择安全阀类型", trigger: "change" },
        ],
        valve_model: [
          { required: true, message: "请输入安全阀型号", trigger: "change" },
        ],
        working_pressure: [
          { required: true, message: "请输入要求整定压力", trigger: "change" },
        ],
        recently_check_date: [
      ...
      this.$client.GetListGasManage().then((res) => {
          if (res.head.result == "200") {
            this.inspection = res.context.filter(item => {
              return item.rule_type == 2
            })
            console.log("111111111",this.inspection)
          } else {
            this.$message({
              showClose: true,
              message: res.head.describle,
