<template>
  <el-form :inline="true" size="mini">
    <el-row>
      ...
      <el-form-item label="安全阀型号">
        <el-input v-model="form.valve_model" clearable></el-input>
      </el-form-item>
      <el-form-item label="安全阀类型" prop="refund_type">
    ...
    <el-row>
      ...
      <el-form-item>
        <el-button type="primary" @click="onBtn('add')">添加安全阀</el-button>
      </el-form-item>
      <el-form-item>
      <el-popconfirm
        @confirm="onBtn('del')"
