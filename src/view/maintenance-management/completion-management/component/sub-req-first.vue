    ...
    <el-form :inline="true" size="mini">
      <el-row>
        ...
        <el-form-item>
          ...
          <!-- <el-form-item>
          <el-button @click="deleteSelect()" type="primary">审核</el-button>
        </el-form-item>
        <el-form-item>
          <el-button @click="deleteSelect()" type="primary">审核退回</el-button>
        </el-form-item> -->
        <!-- <el-form-item>
      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
            ...
            <!-- <el-menu-item index="0" >待接修</el-menu-item>
            <el-submenu index="1">
              <template slot="title">维修中</template>
              <el-menu-item index="3-1">维修中</el-menu-item>
              ...
              <el-menu-item index="3" >待完工检验</el-menu-item>
            <!-- <el-badge :value="200" :max="99" >
             <el-menu-item index="4" >待完工检验</el-menu-item>
            </el-badge>   -->
            <el-menu-item index="4" >待出厂</el-menu-item>
            <el-menu-item index="5" >已出厂</el-menu-item>
            <!-- <el-submenu index="7">
