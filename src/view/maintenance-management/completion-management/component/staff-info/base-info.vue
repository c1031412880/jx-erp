<template>
  <div class="base-info" style="height:60vh;overflow-x:hidden">
    ...
    >
      <div class="el-form-row-first">
        <div class="el-form-row-first-left">
          ...
          <el-form-item label="岗位:" prop="i_position_id">
            <get-position-list v-model="formData.i_position_id" :disabled="curChangeType == 'detail'" v-if="showCollapse == 'first'"></get-position-list>
            <el-input
              placeholder="请选择岗位"
      ...
      <div class="el-form-row">
        ...
        <el-form-item label="联系人手机号:" prop="c_phone">
          <el-input
            ...
            @blur="form.c_phone = $event.target.value"
      ...
      <div class="el-form-row">
        <el-form-item label="状态:" prop="c_job_type">
           <el-select v-model="formData.c_job_type" placeholder="请选择状态" :disabled="curChangeType == 'detail'">
            <el-option
...
export default {
  ...
  watch: {
    showCollapse() {
      ...
      //   alert(111)
      //   this.formData.i_position_id = 999999
      // }
    }
  },
  created() {},
  ...
  methods: {
    ...
    setData(val){
      ...
      this.formData.i_position_id = val.i_position_id
      ...
      this.formData.c_job_type = val.c_job_type
