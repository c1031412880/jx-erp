    ...
    <div>
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="安装车辆" name="second">
          <install-info ref="installInfo" :curChangeType="curChangeType" :batBottleVehicleRecode="batBottleVehicleRecode"></install-info>
        </el-tab-pane>
        <!-- <el-tab-pane label="大修情况" name="third">
          <maintain-condition ref="maintainCondition"></maintain-condition>
        </el-tab-pane> -->
        <el-tab-pane label="报废情况" name="fourth" v-if="curChangeType == 'detail'">
          <scrap-condition ref="scrapCondition"></scrap-condition>
        </el-tab-pane>
        <el-tab-pane label="生命周期" name="six" v-if="curChangeType == 'detail'">
          <life-cycle ref="lifecycle" :batBottleLifeData="batBottleLifeData"></life-cycle>
        </el-tab-pane>
      </el-tabs>
    </div>
...
export default {
  ...
  props: {
    ...
    batBottleVehicleRecode: [Array],
    batBottleLifeData: [Array]
  },
  data() {
    return {
      selectedId: '',
  ...
  methods: {
    ...
    submitFormData() {
      ...
      .then(res => {
        ...
        // 合并信息
        let params = Object.assign({},staffInfoSum.baseInfo,staffInfoSum.installInfo)
        ...
        if(!Object.hasOwnProperty.call(params, 'd_install_dismantle')) {
          delete params.oper_type
          delete params.vehicle
          delete params.installer
          delete params.remark1
        }
        // console.log(params)
        // return
