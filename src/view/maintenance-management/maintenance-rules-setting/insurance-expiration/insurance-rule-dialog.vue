  ...
  >
    <div class="el-dialog-div">
      <el-form ref="form" size="mini" :model="form" :rules="rules" label-width="120px" label-suffix=":">
        ...
        <el-form-item label="年检条件">
          <span>根据车辆最近保险日期判断</span>
        </el-form-item>
        <el-form-item label="提醒人员" prop="person_ids">
          <!-- <get-user-select-tree ref="busAuthorityUser" :isEcho="true" v-model="form.person_ids" style="wdith:100%;height:300px" placeholder="请选择提醒人员"></get-user-select-tree> -->
        ...
        <el-form-item label="规则是否启用" prop="enable">
