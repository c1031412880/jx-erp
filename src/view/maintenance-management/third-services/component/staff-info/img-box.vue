<template>
  <div class="image-box" :id="ImageBoxName">
    <up-file-img v-if="this.imgData.length == 0" style="text-align:center;padding-top: 10%;" :disabled="disabled" @on-file='uploadImg'></up-file-img>
    <div v-if="this.imgData.length != 0" :style="`height:${Number(imageHeight)-60}px`">
        ...
        <div class="show-flex-box-r show-flex-center">
          <el-popover
           ...
           >
            ...
            <el-button slot="reference" :disabled="disabled">备注</el-button>
          </el-popover>
