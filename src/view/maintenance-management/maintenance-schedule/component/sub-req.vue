<template>
  <div>
    <el-form :inline="true" size="mini">
      ...
      <el-row>
        <el-form-item>
          <el-button type="primary" @click="onBtn('setting')" icon="el-icon-plus" v-if="$isPowerShow('maintain-rule-setting')"
            >保养规则设置</el-button
          >
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onBtn('add')" icon="el-icon-edit" v-if="$isPowerShow('add')"
            >添加保养计划</el-button
          >
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onBtn('issue')" icon="el-icon-wind-power" v-if="$isPowerShow('issue')"
            >下发计划</el-button
          >
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onBtn('import')" icon="el-icon-download" v-if="$isPowerShow('import')"
            >导入计划</el-button
          >
        </el-form-item>
