        ...
        <el-dialog
          ...
          <div class="table">
            ...
            <template slot-scope="scope" slot="maint_dept_name" >
              ...
              <template slot-scope="scope" slot="shopidlist" >
               ...
               <template slot-scope="scope" slot="count" >
                 <el-input-number v-model="scope.data.count" @change="countChange(scope.data)" :min="0"  :disabled="disabled1" ></el-input-number>
              </template>
            ...
            <template slot-scope="scope" slot="operation" >
              <el-button type="primary" size="mini"  :disabled="disabled1" @click="deleteRow(scope.data,selectList)">移除</el-button>
            </template>
            </tr-table>
          </div>
          </el-form-item>
