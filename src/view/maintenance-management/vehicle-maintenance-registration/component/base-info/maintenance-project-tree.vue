<template>
  <div ref="organizationTree" class="organization-tree" >
    ...
    <div class="" :style="`height:${TableHeight}px;overflow-y: scroll`">
      <el-tree
        class="filter-tree"
        :check-strictly="true"
        ref="elTree"
      ...
      >
        ...
        <span class="custom-tree-node" slot-scope="{ node }">
          <el-tooltip class="item" effect="dark" :content="node.data.c_name" placement="top" v-if="node.data.c_name.length > 8">
            <span>
